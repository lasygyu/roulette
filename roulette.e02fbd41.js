...
})({"cRaR4":[function(require,module,exports,__globalThis) {
...
function initialize() {
    ...
    const checkNotice = ()=>{
        ...
        if (lastViewed === null || Number(lastViewed) < currentNotice) openNotice();
    };
    checkNotice();
}

},{}]},["cRaR4","jOXmm"], "jOXmm", "parcelRequire5cc2", {})

//# sourceMappingURL=roulette.e02fbd41.js.map
